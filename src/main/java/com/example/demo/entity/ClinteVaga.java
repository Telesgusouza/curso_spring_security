...
//	@ManyToAny
	...
	public ClinteVaga(Long id, String recibo, String placa, String marca, String modelo, String cor,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ClinteVaga other = (ClinteVaga) obj;
		return Objects.equals(id, other.id);
	}

	@Override
	public String toString() {
		return "ClinteVaga [id=" + id + ", recibo=" + recibo + ", placa=" + placa + ", marca=" + marca + ", modelo="
				+ modelo + ", cor=" + cor + ", dataEntrada=" + dataEntrada + ", dataSaida=" + dataSaida + ", valor="
				+ valor + ", desconto=" + desconto + ", dataCriacao=" + dataCriacao + ", dataModificacao="
				+ dataModificacao + ", criadoPor=" + criadoPor + ", modificadoPor=" + modificadoPor + "]";
	}
